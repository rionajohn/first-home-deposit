...
- Test screen layout: `node --test scripts/overlap.test.mjs` (all 32 frames x both text sizes; asserts no divider, border or rule crosses text and no box is squashed below its content)
