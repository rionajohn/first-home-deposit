...
> mark. The cost is two milestone rows below the fold, paid knowingly.
>
...
>
> **A stale measurement noticed in passing and NOT edited here.** The second amendment's "two whole
> rows above the fold" was measured against a 169px block. It has been 103px since the note was
> removed, and is 99px now, and three whole rows clear `.screen-content`'s bottom at either value.
> That figure went stale at the note removal, not at this change, so it is reported here rather than
> quietly rewritten into a paragraph whose own measurements were correct when they were taken.
>
