...
| v11 | 2026-09-13 | pending | Flatten the desktop page background and drop the phone's shadow, so the frame reads on its own (D153). Add the v10 row to the in-app build list, which stopped at v9. | pending |
